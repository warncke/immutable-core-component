...
function toString () {
    ...
    var html = handlebars
        ? handlebars.serverTemplate(this.data, {
    ...
    // and default options from component
    client.refreshInterval = this.component.client.refreshInterval
    client.server = this.component.client.server
    ...
    var script = '(function () {\n'
        +`'use strict';\n`
        +`var component = new ImmutableCoreComponent(${clientArgs});\n`
    // add hooks if any
    ...
    var string = `<div id="${this.id}">${html}</div>\n`
